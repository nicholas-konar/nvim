	...
	config = function()
		require("solarized-osaka").setup({
			...
			on_highlights = function(hl, c)
				...
				hl["@lsp.type.namespace.typescript"] = { fg = c.magenta500 }
